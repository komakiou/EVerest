...
public:
    ...
    evse_board_supportImpl(Everest::ModuleAdapter* ev, const Everest::PtrContainer<RaspiEvseBSP>& mod, Conf& config) :
...
private:
    const Everest::PtrContainer<RaspiEvseBSP>& mod;
    const Conf& config;
    ...
    Everest::Thread i2c_read_thread_handle;
